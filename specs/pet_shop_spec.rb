...
class TestPetShop < Minitest::Test
  ...
  def test_sell_pet_to_customer__pet_found
    ...
    assert_equal(1, customer_pet_count(customer))#pet name is found in pet store, customer pet count +1
    assert_equal(1, pets_sold(@pet_shop))        #pets sold + 1, customer cash -price, total cash +price
